...
argglobal
%argdel
$argadd include/file.h
tabnew
tabnew
tabnew
tabrewind
edit ~/git_repos/for_fun/include/file.h
...
exe 'vert 2resize ' . ((&columns * 105 + 105) / 211)
tabnext
edit ~/git_repos/for_fun/include/mfuncts.h
let s:save_splitbelow = &splitbelow
let s:save_splitright = &splitright
set splitbelow splitright
wincmd _ | wincmd |
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 61 - ((27 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 61
...
argglobal
if bufexists("/usr/share/vim/vim82/doc/starting.txt") | buffer /usr/share/vim/vim82/doc/starting.txt | else | edit /usr/share/vim/vim82/doc/starting.txt | endif
balt ~/git_repos/for_fun/src/sfuncs.c
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
